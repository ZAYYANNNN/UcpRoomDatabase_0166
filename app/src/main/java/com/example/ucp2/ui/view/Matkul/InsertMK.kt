...
import com.example.ucp2.ui.viewModelMK.FormErrorStateMk
import com.example.ucp2.ui.viewModelMK.MatkulEvent
import com.example.ucp2.ui.viewModelMK.MatkulVM
...
fun InsertMatkul(
    ...
    viewModel: MatkulVM = viewModel(factory = PenyediaMkVM .Factory)
)
{
        ...
        Column(
            ...
            InsertBodyMk(
                ...
                onValueChange = { updatedEvent ->
                    viewModel.updateStateMk(updatedEvent) // update state di ViewModel
                },
                onClick = {
                    coroutineScope.launch {
